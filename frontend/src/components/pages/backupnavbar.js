    ...
    <header>
        ...
        <div class="container">
          <ul class="desktop-menu-category-list">
            ...
            <li class="menu-category">
              <a class="menu-title">
                {" "}
                <NavLink to="/Psychics" className="Navlink">
                  {" "}
            ...
            <li class="menu-category">
              ...
              <ul class="dropdown-list">
                ...
                <li class="dropdown-item">
                  <NavLink to="/Blogs" className="Reading">
                    Customer Reviews{" "}
                  </NavLink>
                </li>
              </ul>
      ...
      <nav class="mobile-navigation-menu  has-scrollbar" data-mobile-menu>
        ...
        <ul class="mobile-menu-category-list">
          <li class="menu-category">
            <a class="menu-title" name="removeicon" data-mobile-menu-close-btn>
              {" "}
              <NavLink to="/">Psychics</NavLink>{" "}
            </a>
          </li>
          ...
          <li class="menu-category">
            ...
            <ul class="submenu-category-list" data-accordion>
              ...
              <li class="submenu-category">
                <a class="submenu-title" data-accordion-btn>
                  <NavLink
                    to="/blogs"
                    name="removeicon"
                    data-mobile-menu-close-btn
