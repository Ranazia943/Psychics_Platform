...
const [profiles, setProfiles] = useState([]);
  ...
  const fetchProfiles = async () => {
    try {
      const response = await axios.get(
        `/api/profilestep2/category/Crystal Reading?page=${currentPage}&limit=6`
      );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/getcrystal"); // Update the URL if needed
    ...
    <div>
      <div className="container">
        ...
        <div className="love_banner" data-aos="zoom-in-up">
          <img src={crystalPage.CrystalBanner} alt="love banner" />
        </div>
        <br></br>
        <br></br>
            ...
            <div className="card-body">
              <div id="accordion">
                <div className="card-primary">
                  ...
                  >
                    <div className="card-body">{crystalPage.videoPara}</div>
                  </div>
                </div>
              </div>
            </div>
...
export default Crystal_reading;
