...
const fetchProfiles = async () => {
  try {
    const response = await axios.get(
      `/api/psychics/data/category/Cheating Affairs?page=${currentPage}&limit=6`
    );
...
const handlePageChange = (page) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/cheating"); // Update the URL if needed
            ...
            <div className="card-body box-profile">
              ...
              <NavLink to={`/Psychicsprofile/${profile.Psychics._id}`}>
                <img
                  ...
                  src={
                    profile.Psychics && profile.Psychics.profilePic
              ...
              <h3 className="profile-username text-center">
                {profile.Psychics && profile.Psychics.username}
                <i
              ...
              <p className="text-center">
                {profile.Psychics && profile.Psychics.Introlin}
              </p>
