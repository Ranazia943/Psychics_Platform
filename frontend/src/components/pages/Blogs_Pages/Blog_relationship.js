...
const Blog_realtionship = () => { // Correctly capitalized component name
    ...
    const fetchProfiles = async () => {
      try {
        const response = await axios.get(
          `/api/psychics/data/category/Maritial`
        );
...
export default Blog_realtionship;
