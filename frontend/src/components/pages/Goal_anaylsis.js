...
const Goal_analysis = () => {  // Updated to start with uppercase letter
  ...
  useEffect(() => {
    ...
    const fetchHoroscopesData = async () => {
      try {
        const response = await axios.get("/api/get/goal"); // Update the URL if needed
