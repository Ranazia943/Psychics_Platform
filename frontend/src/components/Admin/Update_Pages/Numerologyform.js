...
const Mediumform = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/numerology");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put("/api/update/numerology", {
        ...formField,
              ...
              <div className="card card-orange">
                <div className="card-header">
                  <h3 className="card-title">
                    <span className="text-white">Numerology Form</span>
                  </h3>
                </div>
