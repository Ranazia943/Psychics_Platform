...
const Crystalform = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/getcrystal");
        setFormField(response.data);
        if (response.data.CrystalBanner) {
          setImagePreview(response.data.CrystalBanner);
        }
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let imageUrl = formField.CrystalBanner;
    ...
    try {
      ...
      const updatedData = {
        ...formField,
        CrystalBanner: imageUrl,
        video: videoUrl,
      };

      await axios.put("/api/update/crystal", updatedData);
              ...
              <div className="card card-orange">
                <div className="card-header">
                  <h3 className="card-title">
                    <span className="text-white">Crystal Form</span>
                  </h3>
                </div>
