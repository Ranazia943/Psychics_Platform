...
const Clairvoyantform = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/clair_sentient");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put("/api/update/clair_sentient", {
        ...formField,
              ...
              <div className="card card-orange">
                <div className="card-header">
                  <h3 className="card-title">
                    <span className="text-white">Cheating Affairs Form</span>
                  </h3>
                </div>
...
export default Clairvoyantform;
