...
const Psychics_profile_details = (props) => { // Access props
  ...
  // Extract psychicId from props.match.params
    ...
    const fetchPsychicData = async () => {
      try {
        ...
        if (response.data && response.data.data) {
          setProfileData(response.data.data); // Set profileData to response.data.data
        } else {
  ...
  // Destructure profileData after confirming it's not null
  const { psychic, profile, profileStep3, profileStep4, profileStep5 } = profileData;

  // Debugging: Log the destructured data
  console.log('Psychic:', psychic);
  console.log('Profile:', profile);
  console.log('ProfileStep3:', profileStep3);
  console.log('ProfileStep4:', profileStep4);
  console.log('ProfileStep5:', profileStep5);
...
export default withRouter(Psychics_profile_details); // Wrap with withRouter